...
class UserContact implements InputFilterAwareInterface
{
    public $id;
    public $instance_id;
    public $user_id;
    ...
    public static function get($id, $column = 'id')
    {
		...
		if ($userContact) {
			...
			$userContact->community_name = $community->name;
		}
		return $userContact;
    }
    ...
    public function loadData($data)
    {
    	...
    	// Check integrity
    	if ($this->vcard_id == '' || !User::getTable()->get($this->user_id)) return 'Integrity';
    	return 'OK';
    }
    ...
    {
    	$userContact = UserContact::get($this->id);
    ...
    public function delete($update_time)
    {
    	...
    	UserContact::getTable()->delete($this->id);
    ...
    {
    	if (!UserContact::$table) {
    		$sm = Context::getCurrent()->getServiceManager();
    		UserContact::$table = $sm->get('PpitCore\Model\UserContactTable');
    	}
    	return UserContact::$table;
    }
}