...
/**
  ...
  */
class Instance implements InputFilterAwareInterface
{
    /** @var int */ public $id;
    ...
    // Static fields
    /** @var \PpitCore\Model\Instance */ private static $table;
    ...
    public function delete()
    {
    	...
    	OrgUnit::getTable()->multipleDelete(array('instance_id' => $this->id));
    }
    ...
    public static function getTable()
    {
    	if (!Instance::$table) {
    		...
    		Instance::$table = $sm->get('PpitCore\Model\InstanceTable');
    	}
