<?php
	return array(
			...
			'Commitment detail' => 'Détail de l’engagement',
			...
			'Deadline' => 'Echéance',
			'Debit order' => 'Avis de prélèvement',
			'Default' => 'Par défaut',
			...
			'Download the invoice drafts' => 'Télécharger les brouillons de factures',
			'Download the invoices' => 'Télécharger les factures',
			...
			'Interns' => 'Stagiaires',
			'Invoice' => 'Facture',
			'Invoice account' => 'Compte à facturer',
			'Invoices' => 'Factures',
			...
			'Options' => 'Options',
			'Or Quantity to divide' => 'Ou Quantité à répartir',
			'Or the same day each month' => 'Ou le même jour chaque mois',
			'Object' => 'Objet',
			...
			'Qty' => 'Qté',
			'Quantity' => 'Quantité',
			'Quantity to divide' => 'Quantité à répartir',
